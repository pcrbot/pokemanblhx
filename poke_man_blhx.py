...
DIR_PATH = os.path.join(os.path.expanduser(
    hoshino.config.RES_DIR), 'img', 'priconne', 'blhx')
DB_PATH = os.path.expanduser("~/.hoshino/_poke_man_blhx.db")
...
sv = Service('poke-man-blhx', help_='''
戳一戳机器人, 她可能会送你碧蓝航线卡片哦~
...
for image in image_list:
    ...
    if chara_id == 1000 or chara_id not in _blhx_data.CHARA_NAME:
        continue
    star = image[14]
